...
bowser.isUnsupportedBrowser=isUnsupportedBrowser;bowser.compareVersions=compareVersions;bowser.check=check;bowser._detect=detect;return bowser});if(bowser.windows){bowser.os='Windows';}
else if(bowser.ios){bowser.os='iOS';}
else if(bowser.mac){bowser.os='OSX';}
else if(bowser.linux){bowser.os='Linux';}
else if(bowser.windowsphone){bowser.os='Windows Phone';}
else if(bowser.chromeos){bowser.os='Chrome OS';}
else if(bowser.android){bowser.os='Android';}
else if(bowser.blackberry){bowser.os='BlackBerry';}
else if(bowser.firefoxos){bowser.os='Firefox OS';}
else if(bowser.webos){bowser.os='WebOS';}
else if(bowser.bada){bowser.os='Bada';}
else if(bowser.tizen){bowser.os='Tizen';}
else if(bowser.sailfish){bowser.os='Sailfish OS';}
if(bowser.mobile){bowser.mobi='Mobile';}
else if(bowser.tablet){bowser.mobi='Tablet';}
else{bowser.mobi='Desktop';}